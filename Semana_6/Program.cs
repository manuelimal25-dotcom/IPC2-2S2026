...
namespace ArbolAVL
{
    public static class Program
    {
        ...
        {
            Console.WriteLine("--------------------------------");
            Console.WriteLine("Menú Principal - Árbol AVL");
            Console.WriteLine("--------------------------------");
        ...
        // Pide un valor al usuario y lo inserta en el árbol. La clase
        // ArbolAVL se encarga internamente de reequilibrar con rotaciones.
        public static void InsertarValor(ArbolAVL arbol)
        {
        ...
        public static void BuscarValor(ArbolAVL arbol)
        {
        ...
        // Pide un valor al usuario y lo elimina del árbol si existe. La
        // clase ArbolAVL reequilibra automáticamente tras la eliminación.
        public static void EliminarValor(ArbolAVL arbol)
        {
        ...
        public static void MostrarRecorridos(ArbolAVL arbol)
        {
        ...
        // Genera el archivo .dot con el estado actual del árbol y lo
        // convierte automáticamente a imagen PNG usando el comando "dot"
        public static void GenerarGrafico(ArbolAVL arbol, Graficador graficador)
        {
